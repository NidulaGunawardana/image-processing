...
class poseDetector():
    def __init__(self, static_image_mode=False,
        ...
        self.smooth_l = smooth_landmarks
        self.enabled_s =  enable_segmentation
        self.smooth_s =  smooth_segmentation
        self.detectionCon =  min_detection_confidence
        self.trackCon = min_tracking_confidence
        self.mpDraw = mp.solutions.drawing_utils
        self.mpPose = mp.solutions.pose
        self.pose = self.mpPose.Pose(self.mode, self.complexity, self.smooth_l,
                                     self.enabled_s, self.smooth_s,self.detectionCon,self.trackCon)
